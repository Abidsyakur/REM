...
session_start();
$data = mysqli_query($conn,"SELECT * FROM program JOIN lokasi ON program.id_lokasi = lokasi.id_lokasi");
$datalok = mysqli_query($conn,"SELECT * FROM lokasi ");
$id_donatur = $_SESSION['id'];
$don = mysqli_query($conn,"SELECT * FROM donatur WHERE id_donatur = $id_donatur");
$hasil = mysqli_fetch_array($don);
