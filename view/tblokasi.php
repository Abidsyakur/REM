...
$penye = mysqli_query($conn,"SELECT * FROM penyelenggara WHERE id_penyelenggara = $id_penyelenggara");
$result = mysqli_fetch_array($penye);
...
.btn-link:hover {
  ...
  <tbody>
    ...
    <tr>
        ...
        <td><?= $item['alamat']?></td>
        <td>
        <a href="editloc.php?id=<?=$item['id_lokasi'];?>" class="btn-link">Edit</a>
        <a href="../func/delloc.php?id=<?=$item['id_lokasi'];?>" class="btn-link">Delete</a>
        </td>
    </tr>
    <?php endforeach; ?>
  </tbody>
