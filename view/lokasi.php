...
button[type="submit"]:hover {
  ...
  <nav>
    ...
    <div class="container" style="margin-top:2rem;margin-bottom:4rem;">
        <div class="row">
            <h2 class="h2">CREATE LOKASI</h2>
        </div>
        <form action="../func/addlokasi.php" method="POST">
  <div class="form-group">
    <label for="nama_lokasi">Nama Lokasi</label>
    <input type="text" id="nama_lokasi" name="nama_lokasi" placeholder="Masukkan nama lokasi event">
  </div>
  <div class="form-group">
