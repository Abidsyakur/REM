...
WHERE program_penyelenggara.id_penyelenggara = $id_penyelenggara");
$datalok = mysqli_query($conn,"SELECT * FROM lokasi ");
$result = mysqli_fetch_array($data);
$pe = mysqli_query($conn,"SELECT * FROM penyelenggara WHERE id_penyelenggara = $id_penyelenggara");
$hasil = mysqli_fetch_array($pe);
?>
...
.btn-link:hover {
  ...
  <thead>
    <tr>
      ...
      <th scope="col">Brosur/pamflet</th>
    </tr>
  </thead>
  <tbody>
    ...
    <tr>
        ...
        <td><?= $item['waktu_mulai']?> s/d <?= $item['waktu_selesai']?></td>
        <td><?= $item['nama_lokasi']?></td>
        <td><img src="../asset/img/program/<?=$item['foto']?>" height="100" alt=""></td>
        <td>
        <a href="editprog.php?id=<?=$item['id_program_penyelenggara'];?>" class="btn-link">Edit</a>
        <a href="../func/delprog.php?id=<?=$item['id_program'];?>" class="btn-link">Delete</a>
        </td>
    </tr>
    <?php endforeach; ?>
  </tbody>
