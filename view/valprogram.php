...
button[type="submit"]:hover {
  ...
  <nav>
		...
		<ul>
          ...
          <ul class="dropdown-menu">
			...
			<li class="logout"><a href="../penyelenggara.php">Back</a></li>
		</ul>
	</nav>

    <div class="container" style="margin-top:2rem;margin-bottom:4rem;">
        <div class="row">
            <h2 class="h2">Validasi</h2>
        </div>
        <form action="../func/progpenye.php" method="POST">
  ...
  <button type="submit" id="submit" name="submit">Selenggarakan</button>
</form>
    </div>
