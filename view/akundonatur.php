...
<html lang="en">
  <head>
    ...
    <title>Akun <?=$result['nama_donatur']?></title>
...
button[type="submit"]:hover {
  ...
  <nav>
    ...
    <div class="container" style="margin-top:2rem;margin-bottom:4rem;">
        ...
        <form action="../func/editdonatur.php" method="POST">
  <div class="form-group">
    <label for="nama_donatur">Nama</label>
    <input type="text" id="nama_donatur" name="nama_donatur" value="<?=$result['nama_donatur']?>">
    <input type="text" id="id_donatur" name="id_donatur" hidden value="<?=$result['id_donatur']?>">
  </div>
  <div class="form-group">
    <label for="nama">Email</label>
    <input type="text" id="email_donatur" name="email_donatur" value="<?=$result['email_donatur']?>">
  </div>
    <div class="form-group">
      <label for="alamat_donatur">Alamat</label>
      <input type="text" id="alamat_donatur" name="alamat_donatur" value="<?=$result['alamat_donatur']?>">
    </div>
    <div class="form-group">
      <label for="notelp_donatur">No Telp</label>
      <input type="text" id="notelp_donatur" name="notelp_donatur" value="<?=$result['notelp_donatur']?>">
    </div>
    <div class="form-group">
