<?php
    ...
    $donatur = mysqli_query($conn,"SELECT program_donatur.id_program_donatur,program.id_program, program.nama_program, donatur.nama_donatur
...
WHERE program_donatur.id_program_donatur = '$id_program_donatur'");
    $result = mysqli_fetch_array($donatur);
...
button[type="submit"]:hover {
  ...
  <nav>
    ...
    <div class="container" style="margin-top:2rem;margin-bottom:4rem;">
        ...
        <form action="../func/editdon.php" method="post">
  <input type="text" value="<?=$result['id_program_donatur']?>" hidden name="id_program_donatur" id="id_program_donatur">
