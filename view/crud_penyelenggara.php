...
button[type="submit"]:hover {
  ...
  <form enctype="multipart/form-data" method="POST" action="../func/addprogram.php">
  <div class="form-group">
    <label for="nama_program">Nama Event</label>
    <input type="text" id="nama_program" name="nama_program" placeholder="Masukkan nama event Anda">
  </div>
  <div class="form-group">
    <label for="deskripsi_program">Deskripsi Event</label>
   <textarea name="deskripsi_program" id="deskripsi_program" cols="30" rows="10" placeholder="masukkan deskripsi event"></textarea>
  </div>
  <div class="form-group">
    <div class="row">
      <div class="col">
  ...
  <option selected>Pilih Lokasi Event</option>
